...
│   run_experiments.txt                         # Module to run experiments
│   run_expeirment_commandline.txt              # Module to run single experiment via commandline
│   run_experiments_hpc_batch_chain.txt         # Module to run experiments on a HPC with PBS
│
